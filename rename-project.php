...
searchDirectoryFiles(getcwd() . '/', 'package-pinnacle', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'PackagePinnacle', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'Package Pinnacle', dashesToCamelCase($argv[1], true, ' '));
